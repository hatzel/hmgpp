#############################################################################
# Makefile for building: hmgpp
# Generated by qmake (3.0) (Qt 5.3.2)
# Project:  hmgpp.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile hmgpp.pro
#############################################################################
...
Makefile: hmgpp.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/hmgpp1.0.0 || mkdir -p .tmp/hmgpp1.0.0
	$(COPY_FILE) --parents $(DIST) .tmp/hmgpp1.0.0/ && $(COPY_FILE) --parents hello.cpp .tmp/hmgpp1.0.0/ && (cd `dirname .tmp/hmgpp1.0.0` && $(TAR) hmgpp1.0.0.tar hmgpp1.0.0 && $(COMPRESS) hmgpp1.0.0.tar) && $(MOVE) `dirname .tmp/hmgpp1.0.0`/hmgpp1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/hmgpp1.0.0
